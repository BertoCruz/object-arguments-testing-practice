...
describe('general challenges', function() {
  ...
  describe('getFavoriteFood', function() {
    ...
    it('should return the favorite food value', function() {
      var foodOpinions = {
  ...
  describe('findDifference', function() {
    it('should find the difference between the amount of money saved vs the cost of an iPad', function() {
  ...
  describe('listFavoriteDestinations', function() {
    it('return list all favorite destinations', function() {
  ...
  describe('filterScores', function() {
    ...
    it('should filter out any scores less than 70 for any given subject', function() {
      var scores = {
